...
// Requête pour récupérer les données de tous les clients
...
if ($result->num_rows > 0) {
    ...
    $clients = array(); // Aucun client trouvé
}
?>
    ...
    <script>
        function confirmLogout() {
            if (confirm("Voulez-vous vraiment vous déconnecter ?")) {
                ...
                window.location.href = "login.php"; // Redirige vers la page de déconnexion
            }
        }
    </script>
...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #FF8800;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#"><img style="padding-right: 0px;margin-top: 11px;" src="assets/img/logo.jpg" width="100">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar" style="margin-top: 19px;">
                    <li class="nav-item">
                        <a class="nav-link" href="Accueil.php"><i class="fas fa-home" style="color: var(--bs-accordion-bg);border-color: var(--bs-accordion-bg);"></i><span>Tableau de bord</span></a></li>
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="Evenement.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-calendar-event-fill" style="color: var(--bs-accordion-bg);">
                            ...
                            </svg><span>&nbsp;Evènements</span></a><a class="nav-link" href="Contact.php"><i class="fas fa-file-contract" style="color: var(--bs-accordion-bg);"></i><span>Contact</span></a>
                        <a class="nav-link active" href="Profil.php"><i class="fas fa-user" style="color: var(--bs-accordion-bg);"></i><span>Profil</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="d-sm-flex justify-content-between align-items-center mb-4" style="margin-bottom: 25px;margin-top: 30px;">
                    <h3 class="text-dark mb-0" style="margin-left: 30px;">Profil</h3>
                </div>
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Username de l'Admin</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><?php echo $_SESSION["nom_admin"]; ?></td>
                        ...
                        <a href="logout.php" class="btn btn-danger" onclick="confirmLogout()">Se déconnecter</a>
