        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="d-sm-flex justify-content-between align-items-center mb-4" style="margin-bottom: 25px;margin-top: 30px;">
                    <h3 class="text-dark mb-0" style="margin-left: 30px;">Voiture</h3>
                </div>
                    
                    <div class="container-fluid">
                        <!-- Les deux boutons : Voitures et Logos -->
                        <div class="row">
                            <div class="col-md-6">
                                <a class="btn btn-primary btn-icon-split" href="Voitures.php">
                            ...
                            <div class="col-md-6">
                                <a class="btn btn-primary btn-icon-split" href="Logo.php">
                                    <span class="icon text-white-50">
